...
try
{
    $file = file_get_contents('./certificate.pem', FALSE, NULL, 0, MAX_UPLOAD_FILESIZE);    
    if (!$file) {
        throw new Exception("Can't open certificate file");
    }
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => "http://signatureverifier.d-logic.com/x509-verifier.php",
